...
(function ssInit() {
    ...
    // ssPreloader(); // Desactivat
    // ssMoveHeader(); // Desactivat
    // ssMobileMenu(); // Desactivat
    // ssScrollSpy(); // Desactivat
    // ssMasonry(); // Desactivat
    // ssSwiper(); // Desactivat
    // ssMailChimpForm(); // Desactivat
    // ssLightbox(); // Fancybox podria interferir aquí
    // ssAlertBoxes(); // Desactivat
    // ssBackToTop(); // Desactivat
    // ssMoveTo(); // Desactivat
